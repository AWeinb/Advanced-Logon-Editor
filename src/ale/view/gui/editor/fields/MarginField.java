...
public abstract class MarginField extends Field {

    private static final long serialVersionUID = 1L;
    private static final int NUMBERLENGTH = 3;
    private static final int FIELDHEIGHT = 80;

    public MarginField(int[] initialValue, Color bg, String fieldTitle) {
    ...
    private void create(int[] init, Color bg, String fieldTitle) {
        ...
        setToolTipText(Field.strMarginTooltip);
