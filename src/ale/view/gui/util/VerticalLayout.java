...
public class VerticalLayout implements LayoutManager {
    ...
    private int alignment; // LEFT, RIGHT, CENTER or BOTH...how the components are
    // justified
     ...
     *            An int value which is one of <code>RIGHT, LEFT, CENTER, BOTH</code> for the horizontal alignment.
     * @param anchor
     *            An int value which is one of <code>TOP, BOTTOM, CENTER</code> indicating where the components are to
